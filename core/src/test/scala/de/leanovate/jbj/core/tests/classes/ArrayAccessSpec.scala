...
class ArrayAccessSpec extends SpecificationWithJUnit with TestJbjExecutor {
  "object array access" should {
    ...
    "ZE2 ArrayAccess and ArrayAccessReferenceProxy with references to main array" in {
      // classes/array_access_011.phpt
      script(
        """<?php
          |
          |// NOTE: This will become part of SPL
        ...
        """string(3) "Foo"
          ...
          |object(ArrayAccessReferenceProxy)#3 (3) {
          ...
          |ArrayAccessReferenceProxy::__construct(0)
          |object(ArrayAccessReferenceProxy)#12 (3) {
          |  ["object":"ArrayAccessReferenceProxy":private]=>
          |  object(Peoples)#2 (1) {
          |    ["person"]=>
          |    &array(1) {
    ...
    "ZE2 ArrayAccess cannot assign by reference" in {
      // classes/array_access_012.phpt
      script(
        """<?php
          |
        ...
        """
          |Notice: Indirect modification of overloaded element of ArrayAccessImpl has no effect in /classes/ArrayAccessSpec.inlinePhp on line 24
          |
          |Fatal error: Cannot assign by reference to overloaded object in /classes/ArrayAccessSpec.inlinePhp on line 24
          |""".stripMargin
      )
    }

    "ZE2 ArrayAccess and exceptions" in {
      // classes/array_access_013.phpt
      script(
        """<?php
          |
