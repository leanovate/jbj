...
class ForeachSpec extends SpecificationWithJUnit with TestJbjExecutor {
  "Foreach" should {
    ...
    "Directly modifying an unreferenced array when foreach'ing over it while using &$value syntax." in {
      // lang/foreachLoop.013.phpt
      script(
        """<?php
          |
          |define('MAX_LOOPS',5);
    ...
    "Directly modifying a REFERENCED array when foreach'ing over it." in {
      // lang/foreachLoop.014.phpt
      script(
        """<?php
          |
          |define('MAX_LOOPS',5);
    ...
    "Directly modifying a REFERENCED array when foreach'ing over it while using &$value syntax." in {
      // lang/foreachLoop.015.phpt
      script(
        """<?php
          |
          |define('MAX_LOOPS',5);
    ...
    "Ensure foreach splits the iterated entity from its cow reference set, for all sorts of iterated entities." in {
      // lang/foreachLoop.016.phpt
      script(
        """<?php
        ...
        """
          ...
          |$a->b
          |
          |Warning: Creating default object from empty value in /lang/ForeachSpec.inlinePhp on line 47
          |array(1) {
          |  [0]=>
          |  string(8) "original"
          |}
          ...
          |$a->b->c
          |
          |Warning: Creating default object from empty value in /lang/ForeachSpec.inlinePhp on line 55
          |array(1) {
          |  [0]=>
          |  string(8) "original"
          |}
          ...
          |$a->b[0]->c
          |
          |Warning: Creating default object from empty value in /lang/ForeachSpec.inlinePhp on line 79
          |array(1) {
          |  [0]=>
          |  string(8) "original"
          |}
          ...
          |C::$a[0]->b
          |
          |Warning: Creating default object from empty value in /lang/ForeachSpec.inlinePhp on line 109
          |array(1) {
          |  [0]=>
          |  string(8) "original"
          |}
